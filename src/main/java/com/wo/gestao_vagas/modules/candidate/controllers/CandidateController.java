...
import com.wo.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
import com.wo.gestao_vagas.modules.candidate.useCases.ProfileCandidateUseCase;
...
public class CandidateController {
    ...
    @Operation(summary = "Cadastro de candidato",
            description = "Essa função é responsável por cadastrar candidato")
    @ApiResponses({
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                    @Content(schema = @Schema(implementation = ProfileCandidateUseCase.class))
            }),
